...
# =====================================================
# 3️⃣ Convert portfolio problem to QUBO → Pauli
# =====================================================
lambda_risk = 0.5
...
# =====================================================
sv = Statevector(ansatz.bind_parameters(vqe_result.optimal_point))
probs = sv.probabilities_dict()
optimal_portfolio = max(probs, key=probs.get)

print("Optimal portfolio bitstring:", optimal_portfolio)
