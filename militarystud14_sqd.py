...
backend = AerSimulator()  # default shot-based simulator
...
# Limit eigenvalues to avoid scipy sparse k >= N-1 error
from qiskit_addon_sqd.qubit import solve_qubit_dense

energies, states = solve_qubit_dense(bitmatrix, H)
